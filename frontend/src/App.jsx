    ...
    <>
      <div className='  flex flex-row selection:text-white selection:bg-black'>
        <div className='h-screen w-3/4 bg-white-100 left-0 top-0 sticky p-5 flex justify-center ' >
          ...
          <div className='rounded-lg mt-20 w-180 h-130 bg-yellow-200 p-5 flex flex-col items-center shadow-[5px_5px_var(--color-black)] border-3 break-all px-10'>
        ...
        <div className=' h-screen w-2/5  bg-yellow-200 overflow-y-auto'>
